...
#SBATCH --output=/data3/yoorheekim/NLP_Study/Week_2/new_skipgram/results/ass_1_b.log
#SBATCH --error=/data3/yoorheekim/NLP_Study/Week_2/new_skipgram/results/ass_1_b.err
